...
pub const QUIC_MAX_UNSTAKED_CONCURRENT_STREAMS: usize = 32;
pub const QUIC_MIN_STAKED_CONCURRENT_STREAMS: usize = 32;
...
pub const QUIC_MAX_STAKED_CONCURRENT_STREAMS: usize = 128;
...
pub const QUIC_UNSTAKED_RECEIVE_WINDOW_RATIO: u64 = 32;

/// The receive window for QUIC connection from minimum staked nodes is
/// set to this ratio times [`solana_sdk::packet::PACKET_DATA_SIZE`]
pub const QUIC_MIN_STAKED_RECEIVE_WINDOW_RATIO: u64 = 32;

/// The receive window for QUIC connection from maximum staked nodes is
/// set to this ratio times [`solana_sdk::packet::PACKET_DATA_SIZE`]
pub const QUIC_MAX_STAKED_RECEIVE_WINDOW_RATIO: u64 = 128;
