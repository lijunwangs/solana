...
pub const QUIC_MAX_UNSTAKED_CONCURRENT_STREAMS: usize = 1000;
pub const QUIC_MIN_STAKED_CONCURRENT_STREAMS: usize = 1000;
...
pub const QUIC_MAX_STAKED_CONCURRENT_STREAMS: usize = 1000;
